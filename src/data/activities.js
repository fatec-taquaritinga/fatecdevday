...
export default [
  ...
  },
  {
    ...
    description: 'Com a convergência de diversos modelos sistêmicos para a nuvem, com o conceito de *containers* amplamente difundido e adotado, novos desafios surgem para os arquitetos e desenvolvedores de *software*. A arquitetura baseada em micro-serviços surge como solução nesse ambiente. A palestra discute aspectos deste tipo de arquitetura e os desafios enfrentados no seu desenvolvimento, ambientados numa demonstração baseada no Netflix OSS.',
  ...
  },
  {
    ...
    description: 'Laravel é um *framework* PHP moderno, com baixa curva de aprendizado, altamente produtivo, seguindo boas práticas de desenvolvimento de *software*. A palestra aborda o PHP moderno, o Composer e o Laravel em detalhes. Dentre os assuntos, fala-se da motivação do *framework*, rotas, *controllers*, *models* e *views*, validação de dados, banco de dados e *migrations*, comandos do Artisan, testes, gerenciamento de *assets* com o Elixir, ambientes de desenvolvimento e *deploy* e referências.',
  ...
  },
  {
    ...
    time: '18h20 - 18h30',
    title: 'Sorteios',
    description: 'Distribuição de descontos em cursos, livros, *squeezes*, etc. oferecidos por nossos parceiros patrocinadores e apoiadores do evento.'
  },
  {
    order: 12,
    icon: 'time_to_leave',
